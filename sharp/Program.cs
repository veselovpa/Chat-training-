    ...
    class Program
    {
        ...
        public static void ReceiveMsg()
        {
            for (; ; )
            {
                ...
                {
                    Console.WriteLine("{0}: {1}", msg.m_Header.m_From, msg.m_Data);
                }
            }
        }
        ...
        static void Main(string[] args)
        {
            ...
            Message m = Message.Send((int)Members.M_BROKER, (int)Messages.M_INIT, "C#");

            int check1;
            string str;
            Console.WriteLine(m.m_Header.m_To);
            for (; ; )
            {
                Console.WriteLine("Send - 0; Quit - 1; All users - 2: ");
                    ...
                    case 2:
                        {
                            ...
                            Message msg = Message.Send((int)Members.M_BROKER, (int)Messages.M_ALLUSER);
                            if (msg.m_Header.m_Type == (int)Messages.M_ALLUSER)
